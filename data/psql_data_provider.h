...
public:
    ...
    std::unique_ptr<ColumnTableBase<bool>> getQueryColumnTable(const std::string& db_name, const std::string& sql);
...
private:
    ...
    QuerySchema getColumnSchema(pqxx::result input, bool has_dummy_tag);
