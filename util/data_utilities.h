...
namespace vaultdb {
    ...
    public:
        ...
        static std::unique_ptr<PlainColumnTable> getQueryColumnTable(const std::string &db_name, const std::string &sql);
        ...
        static SecureTable * readSecretSharedInput(vector<int8_t> & src_data, const QuerySchema &plain_schema, const int & limit = -1);
