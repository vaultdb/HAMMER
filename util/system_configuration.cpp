...
void SystemConfiguration::initializeWirePackedDb(const std::string &db_path, const std::string & temp_data_path) {
    {
...
void SystemConfiguration::initializeOutsourcedSecretShareDb(const string & db_path, const std::string & temp_data_path) {
    stored_db_path_ = db_path;
    temp_db_path_ = temp_data_path;
    Utilities::mkdir(temp_db_path_);
